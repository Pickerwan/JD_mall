package com.android.yttmarket.customView;
...
//		verTextView2 = new View(getContext());
		...
		verTextView1.setLayoutParams(new LayoutParams(0, LayoutParams.MATCH_PARENT));
...
//		textView3.setBackgroundResource(R.drawable.seg_right);
	    verTextView1.setBackgroundColor(getResources().getColor(R.color.blue1));
