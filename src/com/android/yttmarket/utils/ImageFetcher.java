...
import com.android.yttmarket.BuildConfig;
...
//            Log.d(TAG, "downloadBitmap - downloading - " + urlString);
        ...
        try {
            ...
            final InputStream in =
                    new BufferedInputStream(urlConnection.getInputStream(), Util.IO_BUFFER_SIZE);
            out = new BufferedOutputStream(new FileOutputStream(cacheFile), Util.IO_BUFFER_SIZE);
