...
public class VpAdapter extends BaseAdapter {
    ...
    private class ViewHolder {
        TextView state,time,breakout,union,xfTime;
//        address, billNo;
        ImageView ivSg;
//        CheckBox cbSelect;
        ViewPager vp;
...
//        }
    ...
    public void select(int potision, boolean isChecked) {
        isSelected.put(potision, isChecked);
        Message msg = statusHandler.obtainMessage();
        if (isChecked) {
            if (isAllSelected()) {
//                msg.what = TaskCollectFragment.ALL_SELECTED_CHECK; 
            } else {
//                msg.what = TaskCollectFragment.NOT_ALL_SELECTED_CHECK; 
            }
        } else {
//            msg.what = TaskCollectFragment.NOT_ALL_SELECTED_CHECK; 
        }
        ...
        if(isOneSelected()){
//            msgPanel.what = TaskCollectFragment.EXIST_SELECTED_CHECK; 
            statusHandler.sendMessage(msgPanel);
        }else{
//            msgPanel.what = TaskCollectFragment.NOEXIST_SELECTED_CHECK; 
            statusHandler.sendMessage(msgPanel);
        }
    }
